    ...
    <div className='career-middle-bg'>
      <Container>
        <Row>
          ...
          <p>If you are someone who has – a ton of intent, the capacity 
             multitask, an eye for details, and the will to better yourself 
             every day, then contact us today by mailing your resume. 
             Add the subject line as ‘applying for a career with AC for XYZ 
             job position(mention the service). Our team will get in touch with 
             you within 5-7 business days.&nbsp;</p>
            <p>
              <span><strong>Email</strong>: </span>
              <Link to="mailto:ace.chronicle.official.id@gmail.com" className="career-link">
                <span className='career-email'>ace.chronicle.official.id@gmail.com</span>
              </Link>
           </p>
           <h3 className='career-heading1'>We have various job positions such as:</h3>
