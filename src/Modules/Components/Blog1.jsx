                  ...
                  <div className="">
                    ...
                    <ol className="blog-ordered-item pl-4">
                      <li>
                          ...
                          <b className="text-[#848892]">Research keywords : </b> 
                      ...
                      <li>
                          ...
                          <b className="text-[#848892]">Create flagship content : </b> 
                          <span className="text-black">Develop in-depth
                      ...
                      <li>
                          ...
                          <b className="text-[#848892]"> Plan content strategically : </b>
                          <span className="text-black">Create an
                      ...
                      <li>
                          ...
                          <b className="text-[#848892]">Optimize content : </b>
                          <span className="text-black">Naturally include strategic
                      ...
                      <li>
                          ...
                          <b className="text-[#848892]">Focus on users : </b>
                          <span className="text-black">Organize content logically.
                      ...
                      <li>
                          ...
                          <b className="text-[#848892]">Update content regularly : </b>
                          <span className="text-black">Content isn't
